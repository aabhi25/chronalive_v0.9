...
const getNavigationItems = (userRole: string | undefined) => {
  ...
  if (userRole === "super_admin") {
    return [
      ...
      { path: "/admin-dashboard", icon: "fas fa-building", label: "School Administration" },
      { path: "/attendance", icon: "fas fa-clipboard-check", label: "Attendance" },
      { path: "/system-modules", icon: "fas fa-cog", label: "System Modules" },
    ];
  }
  ...
  if (userRole === "student") {
    return [
      { path: "/", icon: "fas fa-tachometer-alt", label: "Dashboard" },
      { path: "/my-class", icon: "fas fa-users", label: "My Class" },
      { path: "/my-profile", icon: "fas fa-user", label: "My Profile" },
    ];
  }
